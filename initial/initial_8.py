...
#         neuron capacitance
# =============================================================================
        self.Cv = torch.normal(torch.tensor(50e-15), 0.05*1e-15)
        self.Cu = torch.normal(torch.tensor(30e-15), 0.05*1e-15)
        self.Cp = torch.normal(torch.tensor(5e-15), 0.05*1e-15)
